          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {success && (
              <Alert className="border-green-200 bg-green-50">
                <AlertDescription className="text-green-700">
                  Supplier information submitted successfully! It will be reviewed by the admin for approval.
                </AlertDescription>
              </Alert>
            )}
            ...
            <div className="p-4 rounded-lg border" style={{ backgroundColor: "#edf5ff", borderColor: "#e7e7e7" }}>
              ...
              <p className="text-sm" style={{ color: "#666" }}>
                All supplier information submitted through this form will be reviewed by the system administrator. You
                will be notified once the supplier is approved and added to the system.
              </p>
            </div>
